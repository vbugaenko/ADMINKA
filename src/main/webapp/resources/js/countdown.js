...
(function () {
    ...
    b.center = function (a) {
        if (this.parent && this.width && this.height) {
            var b = this.x, c = this.y, d = this.parent, e = d.width * 0.5, d = d.height * 0.5, g = this.width * 0.5,
                f = this.height * 0.5;
...
var CountdownImageFolder = "images/", CountdownImageBasename = "flipper", CountdownImageExt = "png",
    CountdownImagePhysicalWidth = 41, CountdownImagePhysicalHeight = 60, CountdownWidth = 200, CountdownHeight = 30;
(function () {
    var c = function (a) {
    ...
    b.init = function () {
        ...
        if (a.time) this.J.setTime((b.getTime() / 1E3 + parseInt(a.time) + 1) * 1E3); else {
            var d = a.year ? parseInt(a.year) : b.getFullYear(), e = a.month ? parseInt(a.month) - 1 : 0,
                g = a.day ? parseInt(a.day) : 0, b = a.hour ? parseInt(a.hour) : 0,
                f = a.minute ? parseInt(a.minute) : 0, h = a.second ? parseInt(a.second) : 0,
        ...
        var p = {
            ...
            shadow: null
        }, w = {font: "Arial, _sans", color: "#303030", weight: "bold"};
                        ...
                        for (var y = new jbeeb.Container({
                            ...
                            for (var A = new jbeeb.Container({x: 0, y: 0, w: q, h: x}), E = [], B = 0; B < 3; B++) {
                                var F = new jbeeb.Box({
                                    ...
                                    w: q,
                                    h: x,
                                    image: {url: c + ("" + z + "" + B) + "." + this.imageExt, mode: "fit"}
                                });
                                E[B] = F;
                                A.addChild(F)
                            }
